    ...
    <div class="container px-4 mx-auto">
      <div class="mb-16 text-center">
        ...
        <p class="max-w-2xl mx-auto text-xl font-body text-muted-foreground">
          Aidez-nous à créer un service libre qui rend l'accès à l'information juridique plus facile et contribuer au
          développement de notre IA.
        </p>
      </div>
      ...
      <div class="grid max-w-5xl gap-8 mx-auto md:grid-cols-3">
        ...
        >
          ...
          <div
            v-if="tier.badge"
            class="absolute z-10 transform -translate-x-1/2 -top-3 left-1/2"
          >
            <div class="flex items-center px-3 py-1 text-sm font-medium rounded-full shadow-md bg-primary text-primary-foreground">
...
const pricingTiers = [
  ...
  },
  {
    ...
    badge: null,
    features: [
      "Un chatbot avec vos données",
      "Votre expertise dans un produit",
